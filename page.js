				...
				<div className='pt-16  ps-5 max-sm:pt-4'>
					...
					>
						<button
							type='button'
							class={
								" focus:outline-none text-white bg-[#E85854] hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-[16px] text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#E85854] dark:hover:bg-red-700 dark:focus:ring-red-900 max-sm:text-[10px] max-sm:py-[5px] max-sm:px-[10px] max-sm:items-center max-sm:mb-0"
							}
						>
				...
				<div className='flex gap-5  justify-between pb-[20px] max-sm:flex-col'>
					...
					<div className='lg:w-1/2 w-[90%] p-10 bg-[#e9e8e8] rounded-[26px] max-sm:w-full max-sm:p-4'>
						...
						<button
							...
							className='focus:outline-none text-white bg-[#E85854] hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-[16px] text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#E85854] dark:hover:bg-red-700 dark:focus:ring-red-900 max-sm:text-[10px] max-sm:py-[5px] max-sm:px-[10px] max-sm:items-center max-sm:mb-0'
						>
